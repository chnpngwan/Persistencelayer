...
public class MemberEntity extends RichEntity {
  ...
  /**
   * @see cn.org.fluent.mybatis.many2many.demo.IEntityRelation#findMyFavoriteOfMemberEntity(List)
   */
  ...
  /**
   * @see cn.org.fluent.mybatis.many2many.demo.IEntityRelation#findExFriendsOfMemberEntity(MemberEntity)
   */
  @RefMethod
  ...
  /**
   * @see cn.org.fluent.mybatis.many2many.demo.IEntityRelation#findCurrFriendOfMemberEntity(MemberEntity)
   */
  @RefMethod
